...
class StringPredicate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["match", "caseSensitive", "value", "negate"]
    ...
    def match_validate_enum(cls, value):
        ...
        if value not in set(['EXACT', 'BEGIN', 'END', 'CONTAINS']):
            raise ValueError("must be one of enum values ('EXACT', 'BEGIN', 'END', 'CONTAINS')")
        return value
