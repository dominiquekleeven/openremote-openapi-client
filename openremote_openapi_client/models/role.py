...
class Role(BaseModel):
    ...
    composite_role_ids: Optional[List[StrictStr]] = Field(default=None, alias="compositeRoleIds")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "composite", "assigned", "compositeRoleIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "compositeRoleIds": obj.get("compositeRoleIds")
        })
        return _obj
