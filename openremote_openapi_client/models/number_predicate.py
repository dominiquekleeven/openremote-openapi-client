...
class NumberPredicate(ValuePredicate):
    """
    NumberPredicate
    """ # noqa: E501
    value: Optional[Union[StrictFloat, StrictInt]] = None
    range_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="rangeValue")
    operator: Optional[StrictStr] = None
    negate: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["predicateType", "value", "rangeValue", "operator", "negate"]
    ...
    def operator_validate_enum(cls, value):
        ...
        if value not in set(['EQUALS', 'GREATER_THAN', 'GREATER_EQUALS', 'LESS_THAN', 'LESS_EQUALS', 'BETWEEN']):
            raise ValueError("must be one of enum values ('EQUALS', 'GREATER_THAN', 'GREATER_EQUALS', 'LESS_THAN', 'LESS_EQUALS', 'BETWEEN')")
        return value
