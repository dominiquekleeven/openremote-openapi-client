...
class MapSourceConfig(BaseModel):
    ...
    minzoom: Optional[StrictInt] = None
    maxzoom: Optional[StrictInt] = None
    attribution: Optional[StrictStr] = None
    custom: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["type", "url", "tiles", "bounds", "scheme", "minzoom", "maxzoom", "attribution", "custom"]
