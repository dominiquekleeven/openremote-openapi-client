...
class Target(BaseModel):
    ...
    allowed_locales: Optional[List[StrictStr]] = Field(default=None, alias="allowedLocales")
    data: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["type", "id", "locale", "allowedLocales", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allowedLocales": obj.get("allowedLocales"),
            "data": obj.get("data")
        })
        return _obj
