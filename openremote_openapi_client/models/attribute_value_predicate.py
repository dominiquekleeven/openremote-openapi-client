...
class AttributeValuePredicate(BaseModel):
    ...
    value: Optional[StringPredicate] = None
    __properties: ClassVar[List[str]] = ["negated", "name", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": StringPredicate.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
