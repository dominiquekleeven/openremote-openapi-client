...
class LocalizedNotificationMessage(AbstractNotificationMessage):
    """
    LocalizedNotificationMessage
    """ # noqa: E501
    default_language: Optional[StrictStr] = Field(default=None, alias="defaultLanguage")
    languages: Optional[Dict[str, AbstractNotificationMessage]] = None
    __properties: ClassVar[List[str]] = ["type", "defaultLanguage", "languages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "languages": dict(
                (_k, AbstractNotificationMessage.from_dict(_v))
