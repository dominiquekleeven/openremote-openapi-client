...
class AttributeRef(BaseModel):
    ...
    AttributeRef
    """ # noqa: E501
    id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The asset identifier")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The attribute name")
