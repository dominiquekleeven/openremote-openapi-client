...
class AssetDatapointLTTBQuery(AssetDatapointQuery):
    """
    AssetDatapointLTTBQuery
    """ # noqa: E501
    amount_of_points: Optional[StrictInt] = Field(default=None, alias="amountOfPoints")
    __properties: ClassVar[List[str]] = ["fromTimestamp", "toTimestamp", "fromTime", "toTime", "type", "amountOfPoints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "amountOfPoints": obj.get("amountOfPoints")
        })
        return _obj
