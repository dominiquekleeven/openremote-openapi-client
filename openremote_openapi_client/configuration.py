...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "http://localhost/api/master" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("openremote_openapi_client")
