...
class PushNotificationAction(BaseModel):
    ...
    open_in_browser: Optional[StrictBool] = Field(default=None, alias="openInBrowser")
    http_method: Optional[StrictStr] = Field(default=None, alias="httpMethod")
    __properties: ClassVar[List[str]] = ["url", "data", "silent", "openInBrowser", "httpMethod"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "openInBrowser": obj.get("openInBrowser"),
