...
class ArrayPredicate(ValuePredicate):
    """
    ArrayPredicate
    """ # noqa: E501
    value: Optional[Dict[str, Any]] = None
    index: Optional[StrictInt] = None
    length_equals: Optional[StrictInt] = Field(default=None, alias="lengthEquals")
    length_greater_than: Optional[StrictInt] = Field(default=None, alias="lengthGreaterThan")
    length_less_than: Optional[StrictInt] = Field(default=None, alias="lengthLessThan")
    negated: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["predicateType", "value", "index", "lengthEquals", "lengthGreaterThan", "lengthLessThan", "negated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value"),
            "index": obj.get("index"),
            "lengthEquals": obj.get("lengthEquals"),
            "lengthGreaterThan": obj.get("lengthGreaterThan"),
            "lengthLessThan": obj.get("lengthLessThan"),
