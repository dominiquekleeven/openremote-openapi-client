...
class Dashboard(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdOn", "realm", "version", "ownerId", "access", "displayName", "template"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "template": DashboardTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None
        })
        return _obj
