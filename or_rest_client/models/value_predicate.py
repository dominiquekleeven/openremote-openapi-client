...
class ValuePredicate(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ArrayPredicate, BooleanPredicate, CalendarEventPredicate, DateTimePredicate, NumberPredicate, RadialGeofencePredicate, RectangularGeofencePredicate, ValueAnyPredicate, ValueEmptyPredicate]]:
        ...
        if object_type ==  'ArrayPredicate':
            return import_module("or_rest_client.models.array_predicate").ArrayPredicate.from_dict(obj)
        if object_type ==  'BooleanPredicate':
            return import_module("or_rest_client.models.boolean_predicate").BooleanPredicate.from_dict(obj)
        if object_type ==  'CalendarEventPredicate':
            return import_module("or_rest_client.models.calendar_event_predicate").CalendarEventPredicate.from_dict(obj)
        if object_type ==  'DateTimePredicate':
            return import_module("or_rest_client.models.date_time_predicate").DateTimePredicate.from_dict(obj)
        if object_type ==  'NumberPredicate':
            return import_module("or_rest_client.models.number_predicate").NumberPredicate.from_dict(obj)
        if object_type ==  'RadialGeofencePredicate':
            return import_module("or_rest_client.models.radial_geofence_predicate").RadialGeofencePredicate.from_dict(obj)
        if object_type ==  'RectangularGeofencePredicate':
            return import_module("or_rest_client.models.rectangular_geofence_predicate").RectangularGeofencePredicate.from_dict(obj)
        if object_type ==  'ValueAnyPredicate':
            return import_module("or_rest_client.models.value_any_predicate").ValueAnyPredicate.from_dict(obj)
        if object_type ==  'ValueEmptyPredicate':
            return import_module("or_rest_client.models.value_empty_predicate").ValueEmptyPredicate.from_dict(obj)
