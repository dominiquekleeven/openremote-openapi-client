...
class X509ProvisioningData(BaseModel):
    ...
    """ # noqa: E501
    ca_cert_pem: Optional[StrictStr] = Field(default=None, alias="CACertPEM")
    ignore_expiry_date: Optional[StrictBool] = Field(default=None, alias="ignoreExpiryDate")
    __properties: ClassVar[List[str]] = ["CACertPEM", "ignoreExpiryDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CACertPEM": obj.get("CACertPEM"),
            "ignoreExpiryDate": obj.get("ignoreExpiryDate")
        })
        return _obj
