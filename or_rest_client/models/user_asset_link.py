...
class UserAssetLink(BaseModel):
    ...
    parent_asset_name: Optional[StrictStr] = Field(default=None, alias="parentAssetName")
    user_full_name: Optional[StrictStr] = Field(default=None, alias="userFullName")
    __properties: ClassVar[List[str]] = ["id", "createdOn", "assetName", "parentAssetName", "userFullName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parentAssetName": obj.get("parentAssetName"),
