...
class DatapointPeriod(BaseModel):
    """
    DatapointPeriod
    """ # noqa: E501
    ...
    oldest_timestamp: Optional[StrictInt] = Field(default=None, alias="oldestTimestamp")
    latest_timestamp: Optional[StrictInt] = Field(default=None, alias="latestTimestamp")
    __properties: ClassVar[List[str]] = ["assetId", "attributeName", "oldestTimestamp", "latestTimestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "oldestTimestamp": obj.get("oldestTimestamp"),
            "latestTimestamp": obj.get("latestTimestamp")
        })
        return _obj
