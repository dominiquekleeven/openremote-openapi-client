...
class NodeSocket(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "nodeId", "index"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['NUMBER', 'NUMBER_ARRAY', 'STRING', 'BOOLEAN', 'TRIGGER', 'COLOR', 'ANY']):
            raise ValueError("must be one of enum values ('NUMBER', 'NUMBER_ARRAY', 'STRING', 'BOOLEAN', 'TRIGGER', 'COLOR', 'ANY')")
        return value
