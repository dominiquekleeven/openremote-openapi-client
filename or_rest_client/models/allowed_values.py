...
class AllowedValues(ValueConstraint):
    """
    AllowedValues
    """ # noqa: E501
    allowed_value_names: Optional[List[StrictStr]] = Field(default=None, alias="allowedValueNames")
    allowed_values: Optional[List[Dict[str, Any]]] = Field(default=None, alias="allowedValues")
    __properties: ClassVar[List[str]] = ["message", "type", "allowedValueNames", "allowedValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "allowedValueNames": obj.get("allowedValueNames"),
