...
class RealmRuleset(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "version", "createdOn", "lastModified", "name", "enabled", "rules", "lang", "meta", "status", "error", "realm", "accessPublicRead"]
