...
from or_rest_client.api_response import ApiResponse, T as ApiResponseT
import or_rest_client.models
from or_rest_client import rest
from or_rest_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(or_rest_client.models, klass)
