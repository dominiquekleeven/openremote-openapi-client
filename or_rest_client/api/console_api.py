...
class ConsoleApi:
    ...
    def register(
        self,
        console_registration: ConsoleRegistration,
        ...
        :param console_registration: (required)
        :type console_registration: ConsoleRegistration
        :param authorization:
        ...
        _param = self._register_serialize(
            console_registration=console_registration,
    ...
    def register_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConsoleRegistration]:
        """Create or update the registration for a console
    ...
    def _register_serialize(
        ...
        if console_registration is not None:
            _body_params = console_registration
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/console/register',
