...
class StatusApi:
    ...
    def get_health_status(
        ...
        _param = self._get_health_status_serialize(
    ...
    @validate_call
    def get_health_status_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_health_status_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_health_status_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
