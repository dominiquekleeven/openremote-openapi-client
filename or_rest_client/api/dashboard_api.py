...
class DashboardApi:
    ...
    def _delete_dashboard_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/dashboard/{realm}/{dashboardId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_realm_dashboards(
        ...
        _param = self._get_all_realm_dashboards_serialize(
            realm=realm,
            authorization=authorization,
            x_forwarded_proto=x_forwarded_proto,
            x_forwarded_host=x_forwarded_host,
    ...
    @validate_call
    def get_all_realm_dashboards_with_http_info(
        self,
        realm: StrictStr,
        authorization: Optional[StrictStr] = None,
        x_forwarded_proto: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_all_realm_dashboards_without_preload_content(
        self,
        realm: StrictStr,
        authorization: Optional[StrictStr] = None,
        x_forwarded_proto: Optional[StrictStr] = None,
    ...
    def _get_all_realm_dashboards_serialize(
        self,
        realm,
        authorization,
        x_forwarded_proto,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dashboard/all/{realm}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def query_dashboards(
        ...
        x_forwarded_proto: Optional[StrictStr] = None,
        x_forwarded_host: Optional[StrictStr] = None,
        dashboard_query: Optional[DashboardQuery] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._query_dashboards_serialize(
            authorization=authorization,
            x_forwarded_proto=x_forwarded_proto,
            x_forwarded_host=x_forwarded_host,
    ...
    @validate_call
    def query_dashboards_with_http_info(
        self,
        authorization: Optional[StrictStr] = None,
        x_forwarded_proto: Optional[StrictStr] = None,
        x_forwarded_host: Optional[StrictStr] = None,
    ...
    @validate_call
    def query_dashboards_without_preload_content(
        self,
        authorization: Optional[StrictStr] = None,
        x_forwarded_proto: Optional[StrictStr] = None,
        x_forwarded_host: Optional[StrictStr] = None,
    ...
    def _query_dashboards_serialize(
        self,
        authorization,
        x_forwarded_proto,
        x_forwarded_host,
