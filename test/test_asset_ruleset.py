...
class TestAssetRuleset(unittest.TestCase):
    """AssetRuleset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetRuleset:
        """Test AssetRuleset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetRuleset`
        """
        model = AssetRuleset()
        if include_optional:
            return AssetRuleset(
