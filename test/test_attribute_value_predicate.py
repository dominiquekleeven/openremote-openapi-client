...
class TestAttributeValuePredicate(unittest.TestCase):
    """AttributeValuePredicate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttributeValuePredicate:
        """Test AttributeValuePredicate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttributeValuePredicate`
        """
        model = AttributeValuePredicate()
        if include_optional:
            return AttributeValuePredicate(
                negated = True,
    ...
    def testAttributeValuePredicate(self):
        """Test AttributeValuePredicate"""
