...
class TestGatewayAssetSyncRule(unittest.TestCase):
    """GatewayAssetSyncRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GatewayAssetSyncRule:
        """Test GatewayAssetSyncRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GatewayAssetSyncRule`
        """
        model = GatewayAssetSyncRule()
        if include_optional:
            return GatewayAssetSyncRule(
                exclude_attributes = [
                    ''
                    ],
    ...
    def testGatewayAssetSyncRule(self):
        """Test GatewayAssetSyncRule"""
