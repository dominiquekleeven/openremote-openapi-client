...
class TestMetaItemDescriptorObject(unittest.TestCase):
    """MetaItemDescriptorObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetaItemDescriptorObject:
        """Test MetaItemDescriptorObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetaItemDescriptorObject`
        """
        model = MetaItemDescriptorObject()
        if include_optional:
            return MetaItemDescriptorObject(
                name = '',
    ...
    def testMetaItemDescriptorObject(self):
        """Test MetaItemDescriptorObject"""
