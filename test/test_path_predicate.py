...
class TestPathPredicate(unittest.TestCase):
    """PathPredicate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PathPredicate:
        """Test PathPredicate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PathPredicate`
        """
        model = PathPredicate()
        if include_optional:
