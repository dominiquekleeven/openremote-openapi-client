...
class TestAssetTypeInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AssetTypeInfo:
        """Test AssetTypeInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetTypeInfo`
        """
        model = AssetTypeInfo()
        if include_optional:
            return AssetTypeInfo(
                asset_descriptor = or_rest_client.models.asset_descriptor_object.AssetDescriptorObject(
                    name = 'H', 
                    icon = '', 
                    colour = '', 
                    dynamic = True, 
                ...
                attribute_descriptors = [
                    or_rest_client.models.attribute_descriptor_object.AttributeDescriptorObject(
                        name = '', 
                ...
                meta_item_descriptors = [
                    or_rest_client.models.meta_item_descriptor_object.MetaItemDescriptorObject(
                        name = '', 
                        type = or_rest_client.models.value_descriptor_object.ValueDescriptorObject(
                            name = 'H', 
                            constraints = [
                ...
                value_descriptors = [
                    or_rest_client.models.value_descriptor_object.ValueDescriptorObject(
                        name = 'H', 
                        constraints = [
                            or_rest_client.models.value_constraint.ValueConstraint(
                                message = '', 
