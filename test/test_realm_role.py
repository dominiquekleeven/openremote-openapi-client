...
class TestRealmRole(unittest.TestCase):
    """RealmRole unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RealmRole:
        """Test RealmRole
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RealmRole`
        """
        model = RealmRole()
        if include_optional:
            return RealmRole(
