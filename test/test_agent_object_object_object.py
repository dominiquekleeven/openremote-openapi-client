...
class TestAgentObjectObjectObject(unittest.TestCase):
    """AgentObjectObjectObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentObjectObjectObject:
        """Test AgentObjectObjectObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgentObjectObjectObject`
        """
        model = AgentObjectObjectObject()
        if include_optional:
            return AgentObjectObjectObject(
    ...
    def testAgentObjectObjectObject(self):
        """Test AgentObjectObjectObject"""
