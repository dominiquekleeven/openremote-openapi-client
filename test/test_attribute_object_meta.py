...
class TestAttributeObjectMeta(unittest.TestCase):
    """AttributeObjectMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttributeObjectMeta:
        """Test AttributeObjectMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttributeObjectMeta`
        """
        model = AttributeObjectMeta()
        if include_optional:
            return AttributeObjectMeta(
                delegate = {
    ...
    def testAttributeObjectMeta(self):
        """Test AttributeObjectMeta"""
