...
class TestMetaItemObject(unittest.TestCase):
    """MetaItemObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetaItemObject:
        """Test MetaItemObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetaItemObject`
        """
        model = MetaItemObject()
        if include_optional:
            return MetaItemObject(
