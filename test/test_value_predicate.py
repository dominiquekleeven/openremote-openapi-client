...
class TestValuePredicate(unittest.TestCase):
    """ValuePredicate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValuePredicate:
        """Test ValuePredicate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuePredicate`
        """
        model = ValuePredicate()
        if include_optional:
