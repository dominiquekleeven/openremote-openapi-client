...
class TestConsoleProvider(unittest.TestCase):
    """ConsoleProvider unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsoleProvider:
        """Test ConsoleProvider
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsoleProvider`
        """
        model = ConsoleProvider()
        if include_optional:
