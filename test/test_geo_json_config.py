...
class TestGeoJsonConfig(unittest.TestCase):
    """GeoJsonConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoJsonConfig:
        """Test GeoJsonConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoJsonConfig`
        """
        model = GeoJsonConfig()
        if include_optional:
