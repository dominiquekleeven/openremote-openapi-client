...
class TestGeofenceDefinition(unittest.TestCase):
    """GeofenceDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeofenceDefinition:
        """Test GeofenceDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeofenceDefinition`
        """
    ...
    def testGeofenceDefinition(self):
        """Test GeofenceDefinition"""
