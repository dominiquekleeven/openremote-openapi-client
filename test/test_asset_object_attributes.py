...
class TestAssetObjectAttributes(unittest.TestCase):
    """AssetObjectAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetObjectAttributes:
        """Test AssetObjectAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetObjectAttributes`
        """
        model = AssetObjectAttributes()
        if include_optional:
            return AssetObjectAttributes(
                delegate = {
    ...
    def testAssetObjectAttributes(self):
        """Test AssetObjectAttributes"""
