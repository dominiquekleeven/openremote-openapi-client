...
class TestAssetConditions(unittest.TestCase):
    """AssetConditions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetConditions:
        """Test AssetConditions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetConditions`
        """
        model = AssetConditions()
        if include_optional:
