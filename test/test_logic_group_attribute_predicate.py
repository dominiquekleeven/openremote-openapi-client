...
class TestLogicGroupAttributePredicate(unittest.TestCase):
    """LogicGroupAttributePredicate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogicGroupAttributePredicate:
        """Test LogicGroupAttributePredicate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicGroupAttributePredicate`
        """
        model = LogicGroupAttributePredicate()
        if include_optional:
            return LogicGroupAttributePredicate(
                operator = 'AND',
                items = [
    ...
    def testLogicGroupAttributePredicate(self):
        """Test LogicGroupAttributePredicate"""
