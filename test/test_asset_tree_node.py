...
class TestAssetTreeNode(unittest.TestCase):
    """AssetTreeNode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetTreeNode:
        """Test AssetTreeNode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetTreeNode`
        """
        model = AssetTreeNode()
        if include_optional:
            return AssetTreeNode(
                asset = or_rest_client.models.asset_object.AssetObject(
                ...
                children = [
                    or_rest_client.models.asset_tree_node.AssetTreeNode(
                        asset = or_rest_client.models.asset_object.AssetObject(
                            id = 'gCu2LC4aWwWL9Y864DZtaG', 
                            version = 0, 
                            created_on = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
