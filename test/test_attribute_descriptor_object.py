...
class TestAttributeDescriptorObject(unittest.TestCase):
    """AttributeDescriptorObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttributeDescriptorObject:
        """Test AttributeDescriptorObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttributeDescriptorObject`
        """
        model = AttributeDescriptorObject()
        if include_optional:
            return AttributeDescriptorObject(
                name = '',
    ...
    def testAttributeDescriptorObject(self):
        """Test AttributeDescriptorObject"""
