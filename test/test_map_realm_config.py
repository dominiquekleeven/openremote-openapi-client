...
class TestMapRealmConfig(unittest.TestCase):
    """MapRealmConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MapRealmConfig:
        """Test MapRealmConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MapRealmConfig`
        """
        model = MapRealmConfig()
        if include_optional:
            return MapRealmConfig(
                center = [
                    1.337
                    ],
                bounds = [
