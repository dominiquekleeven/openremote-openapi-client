...
class TestGlobalRuleset(unittest.TestCase):
    """GlobalRuleset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GlobalRuleset:
        """Test GlobalRuleset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GlobalRuleset`
        """
        model = GlobalRuleset()
        if include_optional:
