...
class TestNodeSocket(unittest.TestCase):
    """NodeSocket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeSocket:
        """Test NodeSocket
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeSocket`
        """
        model = NodeSocket()
        if include_optional:
            return NodeSocket(
